...
namespace Lab5
{
    public class Clothes
    {
        ...
        public string Brand
        {
            ...
            set
            {
                if (value.Length < 4) throw new FormatException("Бренд повинна містити не менше 4 букв!");
        ...
        public static Clothes Parse(string s)
        {
            ...
            Console.WriteLine($"Рядок для розбору: \"{s}\"");
            Console.WriteLine($"Кількість елементів після розділення: {parts.Length}");
